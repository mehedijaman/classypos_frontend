...
const tableColumns = ['Name', 'Deposit', 'Withdraw', 'Balance', 'Date', 'Action']
...
export default {
  data () {
    return {
      Checking: [],
      table: {
        title: 'Bank Ledger List',
        subTitle: 'Ledger List of Bank',
  ...
  methods: {
    ...
    getLedgers () {
      var BankID = this.id
      var UserID = 1
      axios.get('http://techlab.classy.pos/Api/V1/Banks/Bank/Ledger/List/' + BankID + '/' + UserID + '/0/0/0/0/0')
        .then((response) => {
