...
const tableColumns = ['Name', 'Quantity', 'CostPrice', 'SalePrice', 'Date', 'Action']
...
export default {
  data () {
    return {
      Checking: [],
      table: {
        title: 'Product Ledger List',
        subTitle: 'Ledger List of a Product',
  ...
  methods: {
    ...
    getLedgers () {
      ...
      // var UserID = 1
      axios.get('http://techlab.classy.pos/Api/V1/Products/Product/Ledger/' + EmployeeID)
        .then((response) => {
