...
const tableColumns = ['Name', 'Purchased', 'Paid', 'Due', 'Balance', 'Date', 'Action']
...
export default {
  data () {
    return {
      Checking: [],
      table: {
        title: 'Contact Ledger List',
        subTitle: 'Ledger List of a Person',
  ...
  methods: {
    ...
    getLedgers () {
      ...
      var UserID = 1
      axios.get('http://techlab.classy.pos/Api/V1/Contacts/Contact/Ledger/List/' + ContactID + '/' + UserID + '/0/0/0/0/0/0/0/0')
        .then((response) => {
