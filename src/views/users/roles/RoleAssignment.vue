        ...
        <div class="content table-responsive table-full-width">
          <table class="table table-striped">
            ...
            <tr v-for="(product,index) in products" :key="product.id">
              <td v-if="Checking[index]===1"><input type="checkbox" class="checkbox" checked v-on:click="RoleAssign(product.id)"></td>
              <td v-else><input type="checkbox" class="checkbox" v-on:click="RoleAssign(product.id)"></td>
              <td>{{ product.RoleCategoryName }}</td>
              <td>{{ product.RoleRouteName }}</td>
            </tr>
            </tbody>
          </table>
        </div>
...
const tableColumns = ['Select', 'Role Name', 'Route Name']
